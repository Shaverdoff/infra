...
•	status — принимает одно из значений: green/yellow/red: green — всё хорошо; yellow — какие-то шарды отсутствуют/инициализируются, но оставшихся кластеру достаточно, чтобы собраться в консистентное состояние; red — всё плохо, каким-то индексам не хватает шардов до 100% целостности (но новые данные кластер, тем не менее, принимает).
